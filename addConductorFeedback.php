...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO conductor_feedback (fname, lname, bus_num, city, state, zip, comments, date, time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        header("Location: conductor feedback.php?success=1");
        exit;
    }
